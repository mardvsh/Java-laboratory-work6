...
//одной строки фрактала,
    public class FractalWorker extends SwingWorker<Object, Object> {//подкласс SwingWorker с именем FractalWorker, который
        ...
        //класс SwingWorker является универсальным, поэтому нужно указать
        //параметры - можно просто указать Object для двух параметров

        private int y_coord;// целочисленная yкоордината вычисляемой строки
...
//были вычислены в doInBackground ().
    protected void done() {
        ...
        // уменьшите значение «rows remaining» на 1, как
